...
public class LoginAddNewUserPanel extends JPanel {
    public LoginAddNewUserPanel(LoginAddNewUserController controller)
    {
...
//        addNewUserlb.setBounds();
    ...
    static private JTextField txUser, txName, txEmail;
    static private JPasswordField txPassword, txPassword2;
    private TextPrompt userTp, nameTp, emailTp, passTp, pass2Tp;
